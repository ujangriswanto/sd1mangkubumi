  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .ttb-stats::after {
      ...
      flex: 1;
      height: 1px;
      background: linear-gradient(90deg, #d4c5a0, transparent);
    }
    .ttb-stats-badge {
      display: flex;
      align-items: center;
    ...
    .ttb-card-num {
      ...
      color: var(--gold2);
      flex-shrink: 0;
      box-shadow: 0 4px 12px rgba(15,37,64,.2);
    }
    .ttb-card-title {
      font-family: 'Playfair Display', serif;
      font-size: 17px;
...
<body>
  ...
  {{-- Navbar --}}
  <nav class="ttb-nav">
    <a href="javascript:history.back()" class="ttb-nav-back">
  ...
  <div class="ttb-hero">
    ...
    <h1 class="ttb-hero-title">Tata Tertib <span>Sekolah</span></h1>
    <p class="ttb-hero-sub">Peraturan yang wajib diketahui dan dipatuhi oleh seluruh warga sekolah demi terciptanya lingkungan belajar yang kondusif.</p>
  ...
  <div class="ttb-footer-strip">
    <div class="ttb-footer-inner">
      <p>© {{ date('Y') }} — Dokumen ini bersifat resmi dan mengikat seluruh warga sekolah.</p>
